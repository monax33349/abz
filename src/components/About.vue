<template>
  <b-container id="about">
    ...
    <b-row class="about-wrapper">
      <b-col class="wrapper-left" cols="12" md="4">
        <img
          src="@/assets/imgs/man-mobile.svg"
          srcset="@/assets/imgs/man-mobile.svg"
          alt="man-mobile"
        />
      </b-col>
      <b-col class="wrapper-right" cols="12" md="8">
        <div class="text-wrapper">
          <h3>
            I am cool frontend
            <br class="d-md-none" />developer
          </h3>
          ...
          <p
            class="mb-2"
          >Last week, Google Search and Ads teams announced two new speed initiatives to help improve user-experience on the web.</p>
          <a href="#" v-scroll-to="'#singup'">Sign Up</a>
        </div>
      </b-col>
    </b-row>
  </b-container>
